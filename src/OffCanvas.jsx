...
export default function OffCanvas({
  ...
  return (
    ...
    //         {data.role} • {data.duration} • {data.location}
    //       </p>
    //     </div>
    ...
    //       Delivered production-ready UI components and features, improved
    //       product UX, collaborated with backend (.NET) and QA teams, and
